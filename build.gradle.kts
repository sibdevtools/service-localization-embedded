...
publishing {
    publications {
        create<MavenPublication>("mavenJava") {
            ...
            pom {
                packaging = "jar"
                url = "https://github.com/simple-mocks/service-localization-embedded"
                ...
                scm {
                    connection.set("scm:https://github.com/simple-mocks/service-localization-embedded.git")
                    developerConnection.set("scm:git:ssh://github.com/simple-mocks")
                    url.set("https://github.com/simple-mocks/service-localization-embedded")
                }
